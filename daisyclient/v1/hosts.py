...
UPDATE_PARAMS = ('name', 'resource_type', 'dmi_uuid', 'role', 'cluster', 'root_disk','root_lv_size','swap_lv_size','root_pwd','os_version', 'os_status', 'interfaces', 'is_deployment',  'description', 'deleted', 'status','ipmi_user','ipmi_passwd','ipmi_addr')

CREATE_PARAMS = ('id', 'name', 'description', 'resource_type', 'dmi_uuid','role', 'cluster', 'os_version', 'os_status', 'interfaces', 'is_deployment','status','ipmi_user','ipmi_passwd','ipmi_addr')
