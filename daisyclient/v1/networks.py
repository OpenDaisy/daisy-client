...
UPDATE_PARAMS = ('mtu', 'vlan_id', 'ip', 'name', 'cluster_id','ip_ranges', 'vlan_start','vlan_end','gateway','cidr', 'description', 'type','ml2_type','network_type','physnet_name','capability')

CREATE_PARAMS = ('mtu', 'vlan_id', 'ip', 'id', 'name', 'cluster_id','ip_ranges', 'vlan_start','vlan_end','gateway','cidr', 'description', 'type', 'ml2_type','network_type','physnet_name','capability')
...
class NetworkManager(base.ManagerWithFind):
    ...
    def list(self, **kwargs):
        ...
        def paginate(qp, return_request_id=None):
            ...
            url = '/v1/clusters/%s/networks' % qp['ID']
